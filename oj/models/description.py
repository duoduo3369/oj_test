...
class DescriptionDetailFormInfo(object):
    
    def __init__(self,item_id=None,relation_id=None,item_title='',relation_title='',relation_show_order=None,item_show_order=None):
        self.relation_show_order = relation_show_order
...
class Description(object):
    ...
    def __init__(self, description_type_id=None,title=''):
        self.description_type_id = description_type_id
        self.title = title