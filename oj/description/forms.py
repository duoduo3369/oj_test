...
from oj.description.widgets import ItemRelationCombinationField 
...
from oj.description.widgets import DescriptionTypeItemRelationCombinationField    
...
class DescriptionForm(forms.Form):
    description_type = forms.ChoiceField(label=u'可选的描述类型', choices=())
    title = forms.CharField(label='描述标题', max_length = 254)
    
    def __init__(self, *args, **kwargs):
        super(DescriptionForm, self).__init__(*args, **kwargs)
        
        description_type_choice = kwargs["initial"]["description_type_choice"]
        self.fields['description_type'].choices = description_type_choice
...
#
#    description_type = forms.ChoiceField(label=u'可选的描述类型', choices=())
#    title = forms.CharField(label=u'描述标题', max_length = 254)
#    
#    def __init__(self, *args, **kwargs):
#        super(DescriptionForm, self).__init__(*args, **kwargs)
#        description_type_choice = kwargs["initial"]["description_type_choice"]
